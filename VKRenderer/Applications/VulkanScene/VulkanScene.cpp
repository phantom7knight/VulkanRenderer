...
VulkanScene::VulkanScene() : m_showGUILight(true), m_showPhongGUILight(false), m_showBRDFGUILight(true)
{
}
...
void VulkanScene::SetUpCameraProperties(Camera* a_cam)
{
...
void VulkanScene::CreateRenderPass()
{
...
void VulkanScene::CreateFrameBuffers()
{
...
void VulkanScene::CreateDescriptorSets()
{
...
void VulkanScene::CreateCommandBuffers()
{
...
void VulkanScene::CreateSemaphoresandFences()
{
...
void VulkanScene::UpdateUniformBuffer(uint32_t a_imageIndex , CameraMatrices properties_Cam)
{
...
void VulkanScene::DrawGui(VkCommandBuffer a_cmdBuffer)
{
...
void VulkanScene::UpdateCommandBuffers(uint32_t a_imageIndex)
{
...
void VulkanScene::ReCreateSwapChain()
{
...
void VulkanScene::SetUpVertexBuffer(const ModelInfo a_modelDesc, BufferDesc *a_VertexBUffer)
{
...
void VulkanScene::SetUpIndexBuffer(const ModelInfo a_modelDesc, BufferDesc *a_IndexBUffer)
{
...
void VulkanScene::LoadAModel(std::string fileName)
{
...
void VulkanScene::LoadTexture(std::string textureName)
{
...
void VulkanScene::CreateImage(TextureBufferDesc *a_texBuffDesc)
{
...
void VulkanScene::CreateImageTextureView()
{
...
void VulkanScene::CreateDepthResources()
{
...
void VulkanScene::setGuiVariables()
{
...
void VulkanScene::Draw(float deltaTime)
{
